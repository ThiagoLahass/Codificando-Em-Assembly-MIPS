...
array:	.word	0 : 10000	# an array of word, for storing values.
size:	.word	10000	# actual count of the elements in the array.
max: 	.word	1000 	# Set upper bound to 10 (max_int=2147483647)
